...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    ...
    public abstract ChessComponent getCopy();
    ...
    //该方法仅用于子类中写棋子移动时的判断 不需要管
    public boolean judge(ChessComponent[][] chessboard,ChessColor color, ChessboardPoint point) {
        ChessComponent location = chessboard[point.getX()][ point.getY()];
        if (location == null) {
            return false;
        }
        if (location instanceof EmptySlotComponent) {
    ...
    public String toString() {
        ...
        return this.getChessboardPoint()+" "+this.getChessColor().getName();
    }
